	...
	<div ref="modalPlaylist"
		...
		<div class="flex flex-col p-4 w-full max-w-6xl h-5/6 relative bg-white rounded-lg shadow sm:p-5">
			...
			<form @submit.prevent="updatePlaylistData" class="flex flex-col flex-grow space-y-2 overflow-hidden">
				<input v-model="searchList" type="text" class="flex-1 rounded border-2 py-2 px-2"
					placeholder="Cari..." />
				...
				<div class="max-h-full space-y-3">
					<div v-for="screen in listScreen.filter((screen) => statusText(screen.sc_ip) == 'Online')"
						...
						<div class="flex space-x-1 justify-center items-center">
							...
							<div class="rounded shadow-lg px-1 py-2 cursor-pointer hover:bg-PrimaryContainer hover:text-OnPrimaryContainer hover:duration-300"
								:class="{
